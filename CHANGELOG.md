...
- Support for Modulino Thermo (wraps `hs3003` crate for HS3003 sensor)
- Support for Modulino Joystick (analog joystick with button)
...
[Unreleased]: https://github.com/yourusername/modulino-rs/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/yourusername/modulino-rs/releases/tag/v0.1.0
